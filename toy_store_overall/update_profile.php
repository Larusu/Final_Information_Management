...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="username" placeholder="<?= $fetch_profile['username']; ?>" class="box" maxlength="100">
      <input type="email" name="email" placeholder="<?= $fetch_profile['email']; ?>" class="box" maxlength="100" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="number" name="number" placeholder="09123456789" class="box" min="0" max="9999999999999" maxlength="11">
